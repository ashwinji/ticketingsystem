...
function CustomPageJS() {
    ...
    , $(".minirightbar .menuapp-btn2").on("click", function() {
        $(".right_menu2 .right-sidebar2").toggleClass("open stretchRight").siblings().removeClass("open stretchRight"), $(".right_menu2 .right-sidebar2").hasClass("open") ? $(".overlay").fadeIn() : $(".overlay").fadeOut()
    })
