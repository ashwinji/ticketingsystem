         ...
         @if(Request::segment(2)==='view' || Request::segment(2)==='Edit')  
                ...
                <?php $region_id='';
                 ...
                 ?>
                  <div class="row clearfix">                        
                      <div class="col-md-12">
                        {!! Form::open(array('route' => 'ticket-report-Request-AccessEdit','class'=> 'form form-horizontal','enctype'=>'multipart/form-data', 'files'=>true)) !!}
                        {!! Form::token() !!}
            ...
            <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <tbody>
                                ...
                                <?php
                                    $strStart2 = $value->acc_request_time; 
                                    $strEnd2   = $value->acc_granted_time; 
                                ...
                                <tr>                                  
                                    ...
                                    <td> {{ $value->acc_request_time }}</td>
                                    <td> {{ $value->acc_granted_time }}</td> 
                                    <td> @if(!empty($value->acc_granted_time))
