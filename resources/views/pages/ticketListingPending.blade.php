...
<div class="content-body">
    ...
    <div class="row clearfix">
        <div class="col-lg-12">
            <div class="card">
                <div class="header">
                        <h2><strong>Ticket Closing Pending</strong></h2>
                    ...
                    <div class="table-responsive">
                             ...
                             <?php $i = 0; ?>                          
                                ...
                                <tr>                                  
                                   ...
                                   <td>
                                        ...
                                        <a href="{{ route('ticketListPendingEdit',$value->id) }}" class="btn btn-sm btn-orange btn-icon-primary tooltips" data-placement="top" title="View"><i class="fa fa-pencil"></i></a>
                                        @endcan
                                    </td>
                                </tr>
                                <?php $i++; ?>
                     ...
                     @endif
                      @if(Request::segment(2)==='pendingEdit')
                   ...
                   ?>                            
                    {!! Form::open(array('route' => 'ticketListPendingEditStored', 'class'=> 'form form-horizontal','enctype'=>'multipart/form-data', 'files'=>true)) !!}
                    {!! Form::token() !!}  
